...
public class Application {
	...
	public static void main(String[] args) {
		...
		/* compareTo() : 인자로 전달된 문자열과 산진 순으로 비교를 하여
...
//		System.out.println(str2);
		...
		/*indexOf(): 문자열에서 틀정 문자를 탐색하여 처음 일치하는 인덱스 위치의 정수를 반환한다.
...
//		System.out.println(badFileName.replaceAll("../", ""));
		...
		System.out.println("substrin(3):"+ javaoracle.substring(3));
		...
		/* isEmpty() : 문자열의 길이가 0이면 true을 반환, 아니면 false반환
